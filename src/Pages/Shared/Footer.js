...
const Footer = () => {
    return (
        ...
        <footer style={{ backgroundImage: `url(${footer})` }} className="footer grid-rows-2 p-10 bg-neutral text-neutral-content">
            <nav>
            ...
            <div className="footer footer-center p-10 text-white">
                <aside>
                    ...
                    <p className="font-bold">
                        ACME Industries Ltd. <br />Providing reliable Treatment since 1992
                    </p>
